...
- Open-source hardware designs: [GitHub - AnaviTechnology/anavi-knobs-3](https://github.com/AnaviTechnology/anavi-knobs-3)  
- Documentation & build guide: [ANAVI Docs - Macro Pad 10 / Knobs 3 / Knob 1](https://github.com/AnaviTechnology/anavi-docs/blob/main/anavi-macro-pad-10-knobs-3-knob-1/anavi-macro-pad-10-knobs-3-knob-1.md)  

**Firmware**  
- **Base**: CircuitPython (preloaded on device)  
- **Keyboard framework**: KMK (open-source, Python-based firmware for mechanical keyboards)  
  - GitHub: [KMKfw/kmk_firmware](https://github.com/KMKfw/kmk_firmware) (ANAVI-specific board support in `/boards/anavi/knobs3`)  
...
- Official site & downloads: [vb-audio.com/Voicemeeter](https://vb-audio.com/Voicemeeter)  
- User Manual (latest Dec 2025): [Voicemeeter User Manual PDF](https://vb-audio.com/Voicemeeter/Voicemeeter_UserManual.pdf) (covers M.I.D.I. Mapping on pp. 82–84)  
- **MIDI features used**:  

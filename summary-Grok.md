...
Project Overview Custom USB MIDI controller using ANAVI Knobs 3 hardware (3 clickable rotary encoders powered by Seeed Studio XIAO RP2040) running CircuitPython + KMK firmware. Configured to control Voicemeeter virtual audio mixer strips (gain faders, mutes, etc.) for real-time sound mixing (e.g., mic, game, music channels).
Hardware
...
This should now display properly as formatted Markdown when you copy-paste it into a text editor or GitHub. If you’re viewing this in a platform that supports Markdown preview (like VS Code, Obsidian, Typora, or GitHub), just paste and save as README.md — the headings, bold text, lists, and links will render nicely.
Let me know if you’d like any sections expanded, code examples added, or a version with more diagrams/tables!
